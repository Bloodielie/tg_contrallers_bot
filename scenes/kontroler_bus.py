...
from config import DEFAULT_TABLE_BUS, SAVE_DEFAULT_TABLE_BUS, FONT_PNG, bus_number, MESSAGE_KEYBOARD
...
class Scene(BaseScene):
    async def message_handler(self, message: Message):
        ...
        if text in bus_number:
            ...
            data = check_bus(type_bus='bus', data=temporary_data, bus_number=text)
