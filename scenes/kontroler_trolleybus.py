...
from config import JSON_BUS_STOP, DEFAULT_TABLE_BUS, SAVE_DEFAULT_TABLE_TROLLEYBUSES, FONT_PNG, trolleybus_number, MESSAGE_KEYBOARD
...
class Scene(BaseScene):
    async def message_handler(self, message: Message):
        ...
        if text in trolleybus_number:
            ...
            data = bus_check.sort_busstop(check_bus(type_bus='trolleibus', data=temporary_data, bus_number=text), _sort=_data.sort)
